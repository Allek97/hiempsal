...
export const mainPadding = css`
    ...
    ${tw`lg:(padding-left[2.6666666667vw] padding-right[2.6666666667vw])`}
`;
...
export const mainPaddingLeft = css`
    ...
    ${tw`lg:padding-left[2.6666666667vw]`}
`;
...
export const mainPaddingRight = css`
    ...
    ${tw`lg:padding-right[2.6666666667vw]`}
`;
...
export const mainAbsoluteSides = css`
    ...
    ${tw`lg:(left[2.6666666667vw] right[2.6666666667vw])`}
`;
